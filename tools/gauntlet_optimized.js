...
function tick(st, sol, frame, R){
  ...
  if(st.power<20)       {a.h=0.85;a.i=0.10;a.g=0.05;a.r=0.2}
    ...
    if(endGame && ultraHigh) {
      ...
      // Focus on building massive resource buffers to keep all days > 12
      if(o2d < 15 || hd < 15 || fd < 15) {
        // Enhanced buffer building mode - more aggressive thresholds
        if(o2d < hd && o2d < fd) {
          a.h=0.08; a.i=0.70; a.g=0.22; a.r=0.8;  // O2 focus - ultra-aggressive
        } else if(hd < fd) {
          a.h=0.08; a.i=0.70; a.g=0.22; a.r=0.8;  // H2O focus (same as O2)
        } else {
          a.h=0.08; a.i=0.22; a.g=0.70; a.r=0.8;  // Food focus - ultra-aggressive
        }
      } else {
        // All buffers excellent - minimal heating for maximum stability
        a.h=0.12; a.i=0.42; a.g=0.46; a.r=0.8;
      }
    }
  }
